...
java -jar $ADMIN_CLI initialize -u http://localhost:8899 -v
java -jar $ADMIN_CLI create-network -u http://localhost:8899 -v
java -jar $ADMIN_CLI authorize --address DevNMdtQW3Q4ybKQvxgwpJj84h5mb7JE218qTpZQnoA3 --network 0 -u http://localhost:8899 -v
