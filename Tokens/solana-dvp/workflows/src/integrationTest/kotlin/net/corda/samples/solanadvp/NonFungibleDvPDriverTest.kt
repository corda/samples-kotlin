...
import net.corda.samples.solanadvp.flows.NonFungibleTokenDvP
...
class NonFungibleDvPDriverTest {
    ...
    fun testDvp() = withDriver {
        ...
        val result = partyA.rpc.startFlow(
            ::CreateAndIssueNonFungibleToken,
        ...
        partyA.rpc.startFlow(::NonFungibleTokenDvP, id, partyB.nodeInfo.legalIdentities[0])
            .returnValue.get()
