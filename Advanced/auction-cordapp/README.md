...
different features of Corda like [SchedulableState](https://docs.r3.com/en/platform/corda/4.14/community/api-states.html#the-queryablestate-and-schedulablestate-interfaces),
[StatePointer](https://docs.r3.com/en/platform/corda/4.14/community/api-states.html#state-pointers) and
[OwnableState](https://docs.r3.com/en/platform/corda/4.14/community/api-states.html#ownablestate). It also demonstrates
