package net.corda.samples.solana.bridging.token.dvp.contracts

import com.r3.corda.lib.tokens.contracts.types.TokenType
import net.corda.core.contracts.Amount
import net.corda.core.identity.CordaX500Name
import net.corda.samples.solana.bridging.token.dvp.states.SharesPaymentState
...
class SharesPaymentContractTests {
    ...
    private val ledgerServices = MockServices(listOf("net.corda.samples.solana.bridging.token.dvp"))
