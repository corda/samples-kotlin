...
This CorDapp provides a simple example of how the node database can be accessed in flows using a [JDBC Connection](https://docs.r3.com/en/platform/corda/4.14/community/api-persistence.html#jdbc-session). In this case, the flows
...
For development environment setup, please refer to: [Setup Guide](https://docs.r3.com/en/platform/corda/4.14/community/getting-set-up.html).
