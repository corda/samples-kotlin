// File: workflows/src/main/kotlin/net/corda/samples/referencestates/flows/IOUIssueFlow.kt
...
/**
 * Flow to issue an IOU with sanctions checking
 */
@InitiatingFlow
@StartableByRPC
class IOUIssueFlow(
...
class IOUIssueFlowAcceptor(val otherPartySession: FlowSession) : FlowLogic<SignedTransaction>() {
    @Suspendable
    override fun call(): SignedTransaction {
