...
This CorDapp is a simple showcase of [confidential identities](https://docs.r3.com/en/platform/corda/4.14/community/api-identity.html#confidential-identities) (i.e. anonymous public keys).
