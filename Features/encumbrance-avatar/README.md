...
Corda supports the idea of "Linked States", using the [TransactionState.encumbrance](https://docs.r3.com/en/platform/corda/4.14/community/key-concepts-contracts.html#encumbrances) property. When building a transaction, a state `x` can
...
Read more about Encumbrances [here](https://docs.r3.com/en/platform/corda/4.14/community/key-concepts-contracts.html#encumbrances).
