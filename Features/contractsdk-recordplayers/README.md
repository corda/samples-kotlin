...
A Record Player is issued as a [LinearState](https://docs.r3.com/en/platform/corda/4.14/community/api-states.html#linearstate) and is updated by dealers, that act functionally as the only entity that can update the `RecordPlayerState`.
