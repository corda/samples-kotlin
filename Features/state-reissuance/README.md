...
This CorDapp serves as a sample for [state reissuance](https://docs.r3.com/en/platform/corda/4.14/community/reissuing-states.html#consuming-an-original-state-instead-of-deleting-it) feature of Corda. This feature enables developers to break long 
...
This samples demonstrates the feature with the help of a [linear state](https://docs.r3.com/en/platform/corda/4.14/community/api-states.html#linearstate), represented by a land title issued on Corda ledger. 
...
[Set up for CorDapp development](https://docs.r3.com/en/platform/corda/4.14/community/getting-set-up.html)
